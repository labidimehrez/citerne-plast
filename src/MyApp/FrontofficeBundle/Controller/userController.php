...
//        var_dump($user);exit;
        return $this->render('MyAppFrontofficeBundle:usermanager:show.html.twig', array(
                    'users' => $user
        ));
    }
    public function deleteAction($id) {
        ...
        return $this->redirect($this->generateUrl('my_app_frontoffice_user_show'));
    }
       ...
       $user = $em->getRepository('MyAppUtilisateurBundle:Utilisateur')->find($id);
        ...
        return $this->render('MyAppFrontofficeBundle:usermanager:edit.html.twig', array('form' => $form->createView()));
    }
       ...
       public function addAction() {
        ...
        return $this->render('MyAppFrontofficeBundle:usermanager:add.html.twig', array(
